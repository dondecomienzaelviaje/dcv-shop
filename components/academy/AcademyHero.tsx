      ...
      <Container>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-8 text-5xl font-black leading-tight md:text-7xl">
            Aprende las habilidades que transforman tu vida.
          </h1>

          <p className="mx-auto mt-8 max-w-3xl text-xl leading-9 text-neutral-400">
            Una academia diseñada para desarrollar disciplina,
            productividad, liderazgo, finanzas y crecimiento personal
            mediante cursos prácticos creados para generar resultados.
          </p>
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <button className="rounded-xl border border-neutral-700 px-8 py-4 font-bold transition hover:border-[#C8A04A] hover:text-[#C8A04A]">
